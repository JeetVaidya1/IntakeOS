      ...
      <main className="container mx-auto px-4 py-8 max-w-6xl relative">
        ...
        <div className="mb-12 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div className="flex items-center gap-3 mb-3">
            <h1 className="text-4xl font-bold tracking-tight text-white">Create New Bot</h1>
            <div className="flex h-2 w-2 rounded-full bg-gradient-to-r from-cyan-400 to-purple-400 animate-pulse"></div>
          </div>
          <p className="text-slate-300 mb-6 text-lg">Describe what information you need and AI will build your intake form</p>
        ...
        <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100">
          ...
          {!bots || bots.length === 0 ? (
            <Card className="p-16 text-center bg-white/5 backdrop-blur-lg border-dashed border-2 border-white/10 hover:bg-white/10 transition-colors">
              ...
              <h3 className="text-xl font-semibold mb-2 text-white">Create your first bot above</h3>
              <p className="text-slate-400">Once created, it will appear here</p>
            </Card>
          ) : (
              ...
              {bots.map((bot: any, index: number) => {
                ...
                return (
                  <Link key={bot.id} href={`/dashboard/bots/${bot.id}`}>
                    <Card className={`p-6 h-full cursor-pointer bg-slate-900/40 backdrop-blur-lg border ${colors.border} ${colors.hoverBorder} hover:shadow-2xl ${colors.shadow} transition-all duration-300 group relative overflow-hidden`}>
